...
import numpy as np
# SETTING TO CURRENT DIR - START
import os
import sys
import inspect
# sgm = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
# sgm_parent = os.path.dirname(sgm)
# sys.path.insert(0, sgm_parent)
# import sgmdata
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))))
import sgmdata
# SETTING TO CURRENT DIR - END
...
for filename in glob.iglob('/Users/roseh/Desktop/Internship/MyCode/h5Files/*LCC*.hdf5', recursive=True):
    l.append(filename)
print(l)
...
sgm_data = sgmdata.load.SGMData(l, sample='LCC_i_Si')
