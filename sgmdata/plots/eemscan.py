...
def plot(**kwargs):
    ...
    button = Button(label="Download XAS", button_type="success", height_policy="min", height=height*1//15, width=width*3//16)
    checkbox_group = RadioGroup(labels=["dx/dy", "1/y", "None"], active=2, name="Functions", height=height*1//15, width=width*3//16)
