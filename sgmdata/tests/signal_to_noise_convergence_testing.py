# # General imports
# import glob
# from IPython.tests.globalipapp import get_ipython
# import asyncio
# import h5py
# import pandas
...
# for filename in glob.iglob('/Users/roseh/Desktop/Internship/MyCode/h5Files/*Imidazol*.hdf5', recursive=True):
#     l.append(filename)
# # print(l)
#
#
...
# #     sdd_vals.append(df.filter(regex=("sdd.*"), axis=1).to_numpy())
# #
# # i = 0
# # while i < len(sdd_vals):
# #     print("Scan " + str(i) + ". ")
# #     i2 = 0
# #     while i2 < 6:
# #         print("\t Array: " + str(i2))
# #         i3 = 0
# #         while i3 < 16:
# #             if sdd_vals[i][i2][i3] != 0:
# #                 print(".\t\t\tValue:\t" + str(sdd_vals[i][i2][i3]))
# #             i3 += 1
# #         i2 += 1
# #     i += 1
#
...
# #         if "sdd" in item:
# #             if i2 < 2:
# #                 print("\t" + str(i2) + ".\tSignal:\t" + str(item))
# #                 i3 = 1
# #                 for key in y[item]:
# #                     print("\t\t" + str(i3) + "\t\tKey: " + str(key))
# #                     i3 += 1
# #                 i2 += 1
#
#
...
#     """
#     Takes a set of x and y values, and prints out various information about the y values. Used for tests.
#     Variables:
...
#
#     # for val in range(len(sdd_list)):
#     #     print("Sample\t" + str(val))
#     #     i = 0
#     #     for arr in sdd_list[val]:
#     #         if i < 6:
#     #             print("\t\tArr:\t" + str(arr))
#     #             i += 1
#     #             i2 = 1
...
#     #                 if arr_val != 0.0:
#     #                     if i2 < 6:
#     #                         print("\t\t\t" + str(i2) + ".\tarr_val:\t" + str(arr_val))
#     #                         i2 += 1
#
...
# # # Fits our 'noisemodel' calling of the 'noise' function with data set to diff_list and idx set to an arrayed
# # # version of indices and the same parameters we previously set.
# # result_noise = noisemodel.fit(returned_diff_list, idx=np.array(returned_indices), params=params)
# # chosen_vals = result_noise.best_values
# #
...
# #                                                    np.add(returned_indices, 1)]) - chosen_vals['ofs'])
# #                                               ])
#
#
# # AVERAGING DATA
